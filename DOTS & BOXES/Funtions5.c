...
void p1Vsp2_5 (){
    ...
    int ch=0,i,l,b,score1=0,score2=0,x,num,y,v,m,z,n,k,u,q=65,r=0,f=0,temp=0,x1=0,y1=0,flag=0,x2=0,y2=0,undo=0,P=0,f2=0,J=16,rr=0,moves=60,K=0,H=0;
    time_t start=0, finish=0;

    start = clock();

    ColorS22(a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,f,J,start,finish,num,moves,K,H);
  ...
  Arrows2(ch,a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,&f,&J,start,finish,num,moves,K,H);
  }else if (ch==13){
  Detect_Check2(&flag,J,f,start,finish,&x1,&y1,&x2,&y2,a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,num,moves,K,H);
  if (flag==2){
    K++;
  }
  }else if (ch==117){
         Undo2(a6,&rr,&undo,k,v,m,u,a,a3,a5,&r,&score1,&score2,&flag,&f2,&moves,&K,&H,num);
         if (f2>0){
            num--;
            f2=0;
         }
        ...
        ColorS22(a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,f,J,start,finish,num,moves,K,H);
            ...
            Redo2(a6,&rr,&undo,k,v,m,u,a,a3,a5,&r,&score1,&score2,&flag,&f2,&moves,&K,&H);
            if (f2>0){
            num--;
            f2=0;
         }
        ...
        ColorS22(a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,f,J,start,finish,num,moves,K,H);
           ...
           gotoxy(40,9);
            ...
            while((choi!='1') && (choi!='2') && (choi!='3')){
                ...
                printf("                     ");
            if(choi=='1'){
                save12(a,rr,a6,r,a3,C,a5,J,f,score1,score2,finish,K,H,moves);
                Sleep(500);
                gotoxy(40,15);
                printf("                                                    ");
                gotoxy(40,9);
                ...
                save22(a,rr,a6,r,a3,C,a5,J,f,score1,score2,finish,K,H,moves);
                Sleep(500);
                gotoxy(40,15);
                printf("                                                    ");
                gotoxy(40,9);
                ...
                save32(a,rr,a6,r,a3,C,a5,J,f,score1,score2,finish,K,H,moves);
                Sleep(500);
                gotoxy(40,15);
                printf("                                                    ");
                gotoxy(40,9);
...
if (ch==13){
undo = 0;
Drawing2(x1,x2,y1,y2,&rr,a,a6,&moves,num);
    }
    S12(a,a3,&r,&score1,a5,&num,&score2);
    if(moves==0){
        ColorS22(a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,f,J,start,finish,num,moves,K,H);
...
undo = 0;
  Drawing2(x1,x2,y1,y2,&rr,a,a6,&moves,num);
    ...
    S22(a,a3,&r,&score1,a5,&num,&score2);
    if(moves==0){
        ColorS22(a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,f,J,start,finish,num,moves,K,H);
        player1.score = score1;
        player2.score = score2;
...
void p1Vsp2_5_load1 (){
    ...
    time_t start=0, finish=0;
 start=clock();
    load111(a,&rr,a6,&r,a3,C,a5,&J,&f,&score1,&score2,&finish,&K,&H,&moves);
    int YY;
    YY=rr;
    ...
    for (num=a6[4][rr-1]+1; num<85; num++){
...
void p1Vsp2_5_load2 (){
   ...
   char C[16][17]={{'*',' ',' ','*',' ',' ','*',' ',' ','*',' ',' ','*',' ',' ','*','<'},
    ...
    time_t start=0, finish=0;
start=clock();
    load222(a,&rr,a6,&r,a3,C,a5,&J,&f,&score1,&score2,&finish,&K,&H,&moves);
    int YY;
    YY=rr;
    finish=clock()+timee.hhh;
    ColorS22(a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,f,J,start,finish,num,moves,K,H);
...
void p1Vsp2_5_load3 (){
    ...
    time_t start=0, finish=0;
start=clock();
    load333(a,&rr,a6,&r,a3,C,a5,&J,&f,&score1,&score2,&finish,&K,&H,&moves);
    int YY;
    YY=rr;
    finish=clock()+timee.hhh;
    ColorS22(a6,C,a,GHline,GVline,a5,a3,aa,rr,score1,score2,r,f,J,start,finish,num,moves,K,H);
